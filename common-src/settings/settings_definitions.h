...
extern const char ACTION_ID_CHANGE_TO_TAB_1[];
extern const char ACTION_ID_CHANGE_TO_TAB_2[];
extern const char ACTION_ID_CHANGE_TO_TAB_3[];
extern const char ACTION_ID_CHANGE_TO_TAB_4[];
extern const char ACTION_ID_CHANGE_TO_TAB_5[];
extern const char ACTION_ID_CHANGE_TO_TAB_6[];
extern const char ACTION_ID_CHANGE_TO_TAB_7[];
extern const char ACTION_ID_CHANGE_TO_TAB_8[];
...
extern const char ACTION_ID_UNDO[];
extern const char ACTION_ID_REDO[];
extern const char ACTION_ID_CUT[];
...
extern const char ACTION_ID_VAPOURSYNTH_VERSION[];
extern const char ACTION_ID_PLUGINS_FOLDER[];
extern const char ACTION_ID_SCRIPTS_FOLDER[];
...
extern const char ACTION_ID_SHOW_BOOKMARK_MANAGER[];
extern const char ACTION_ID_SHOW_FRAME_INFO_DIALOG[];
extern const char ACTION_ID_SHOW_PREVIEW_FILTERS_DIALOG[];
extern const char ACTION_ID_SHOW_SELECTION_TOOLS_DIALOG[];
...
extern const char ACTION_ID_SAVE_BOOKMARK_TO_FILE[];
