	...
	const QString & a_scriptName)
{
    ...
    EncodingPreset preset = m_pSettingsManager->getEncodingPresetSelection();
...
{
    m_pSettingsManager->setEncodingPresetSelection(a_text);
...
void EncodeDialog::setUpEncodingPresets()
{
    ...
    int savedPreset = m_ui.encodingPresetComboBox->
                        findText(m_pSettingsManager->getEncodingPresetSelection());
    m_ui.encodingPresetComboBox->setCurrentIndex(savedPreset);

	slotEncodingPresetComboBoxActivated(
        m_pSettingsManager->getEncodingPresetSelection());
}
