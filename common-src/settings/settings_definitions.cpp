...
const char ACTION_ID_CHANGE_TO_TAB_1[] = "change_to_tab_1";
const char ACTION_ID_CHANGE_TO_TAB_2[] = "change_to_tab_2";
const char ACTION_ID_CHANGE_TO_TAB_3[] = "change_to_tab_3";
const char ACTION_ID_CHANGE_TO_TAB_4[] = "change_to_tab_4";
const char ACTION_ID_CHANGE_TO_TAB_5[] = "change_to_tab_5";
const char ACTION_ID_CHANGE_TO_TAB_6[] = "change_to_tab_6";
const char ACTION_ID_CHANGE_TO_TAB_7[] = "change_to_tab_7";
const char ACTION_ID_CHANGE_TO_TAB_8[] = "change_to_tab_8";
...
const char ACTION_ID_UNDO[] = "undo";
const char ACTION_ID_REDO[] = "redo";
const char ACTION_ID_CUT[] = "cut";
const char ACTION_ID_COPY[] = "copy";
const char ACTION_ID_PASTE[] = "paste";
...
const char ACTION_ID_VAPOURSYNTH_VERSION[] = "vapoursynth_version";
const char ACTION_ID_PLUGINS_FOLDER[] = "plugins_folder";
const char ACTION_ID_SCRIPTS_FOLDER[] = "scripts_folder";
